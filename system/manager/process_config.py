...
procs = [
  ...
  PythonProcess("updated", "system.updated.updated", always_run, enabled=not PC, nice=19),
...
procs += [
  ...
  PythonProcess("ha_pushd", "starpilot.system.ha_pushd", always_run, enabled=TICI, nice=19),
