...
class DriverStatus():
  def __init__(self, rhd_saved=False, settings=None):
    ...
    self.hi_stds = 0
    self.threshold_pre = 2 #self.settings._DISTRACTED_PRE_TIME_TILL_TERMINAL / self.settings._DISTRACTED_TIME
    self.threshold_prompt = 2 # self.settings._DISTRACTED_PROMPT_TIME_TILL_TERMINAL / self.settings._DISTRACTED_TIME
